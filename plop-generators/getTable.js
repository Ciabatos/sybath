  ...
  plop.setGenerator(generatorName, {
    ...
    prompts: async (inquirer) => {
      ...
      const filesCreated = [
        ...
        `.vscode/use${schemaTablePascalName}.code-snippets`,
        `.vscode/use${schemaTablePascalName}ByKey.code-snippets`,
    ...
    actions: [
      ...
      {
        type: "add",
        path: "../.vscode/use{{schemaTablePascalName}}.code-snippets",
        templateFile: "plop-templates/getTable/snippetHookTable.hbs",
        force: true,
      },
      {
        type: "add",
        path: "../.vscode/use{{schemaTablePascalName}}ByKey.code-snippets",
