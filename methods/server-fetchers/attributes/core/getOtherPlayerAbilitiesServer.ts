...
import type { TOtherPlayerAbilitiesRecordByAbilityId,TOtherPlayerAbilities } from "@/db/postgresMainDatabase/schemas/attributes/otherPlayerAbilities"
...
export async function getOtherPlayerAbilitiesServer( params: TOtherPlayerAbilitiesParams, options?: { forceFresh?: boolean },): Promise<TResult> {
