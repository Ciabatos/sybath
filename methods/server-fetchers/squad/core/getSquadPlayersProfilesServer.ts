...
import type { TSquadPlayersProfilesRecordByOtherPlayerId,TSquadPlayersProfiles } from "@/db/postgresMainDatabase/schemas/squad/squadPlayersProfiles"
...
export async function getSquadPlayersProfilesServer( params: TSquadPlayersProfilesParams, options?: { forceFresh?: boolean },): Promise<TResult> {
