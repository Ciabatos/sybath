...
### Data Flow
function doAddItemToInventoryService(params: TDoAddItemToInventoryServiceParams)
path: methods/services/inventory/doAddItemToInventoryService.ts
...
path: db/postgresMainDatabase/schemas/inventory/doAddItemToInventory.ts
TypeScript Types:
...
PostgreSQL Database
"schema": "inventory"
"method": "do_add_item_to_inventory"
