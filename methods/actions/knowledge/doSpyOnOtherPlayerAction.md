...
### Data Flow
function doSpyOnOtherPlayerService(params: TDoSpyOnOtherPlayerServiceParams)
path: methods/services/knowledge/doSpyOnOtherPlayerService.ts
...
path: db/postgresMainDatabase/schemas/knowledge/doSpyOnOtherPlayer.ts
TypeScript Types:
