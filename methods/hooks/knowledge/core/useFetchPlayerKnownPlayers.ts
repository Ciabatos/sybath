...
"use client"
import { TPlayerKnownPlayersRecordByOtherPlayerId, TPlayerKnownPlayers , TPlayerKnownPlayersClientParams  } from "@/db/postgresMainDatabase/schemas/knowledge/playerKnownPlayers"
...
export function useFetchPlayerKnownPlayers( params: TPlayerKnownPlayersClientParams) {
  ...
  const { data } = useSWR<TPlayerKnownPlayers[]>(`/api/knowledge/rpc/get-player-known-players/${params.playerId}`, { refreshInterval: 3000 })
