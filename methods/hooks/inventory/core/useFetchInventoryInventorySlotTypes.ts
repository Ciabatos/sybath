...
"use client"
import { TInventoryInventorySlotTypesRecordById, TInventoryInventorySlotTypes } from "@/db/postgresMainDatabase/schemas/inventory/inventorySlotTypes"
...
export function useFetchInventoryInventorySlotTypes() {
  ...
  const { data } = useSWR<TInventoryInventorySlotTypes[]>(`/api/inventory/inventory-slot-types`, { refreshInterval: 3000 })
