...
"use client"
import { TDistrictInventoryRecordBySlotId, TDistrictInventory , TDistrictInventoryClientParams  } from "@/db/postgresMainDatabase/schemas/inventory/districtInventory"
...
export function useFetchDistrictInventory( params: TDistrictInventoryClientParams) {
