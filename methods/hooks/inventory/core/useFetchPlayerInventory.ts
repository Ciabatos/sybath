...
"use client"
import { TPlayerInventoryRecordBySlotId, TPlayerInventory , TPlayerInventoryClientParams  } from "@/db/postgresMainDatabase/schemas/inventory/playerInventory"
...
export function useFetchPlayerInventory( params: TPlayerInventoryClientParams) {
