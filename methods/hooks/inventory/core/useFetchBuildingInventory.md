...
app/api/inventory/rpc/get-building-inventory/[buildingId]/route.ts TypeScript Types: type TApiParams = Record<string,
string>

const typeParamsSchema = z.object({ userId: z.coerce.string(), buildingId: z.coerce.number(), }) satisfies
z.ZodType<TBuildingInventoryParams>
...
{ userId: string buildingId: number }

export type TBuildingInventory = { slotId: number containerId: number inventoryContainerTypeId: number
...
function path :methods/hooks/inventory/core/useMutateBuildingInventory.ts function useMutateBuildingInventory( params:
TBuildingInventoryParams) PostgreSQL Database "schema": "inventory" "method": "get_building_inventory" You have more
