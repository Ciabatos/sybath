...
app/api/world/rpc/get-player-map/[playerId]/route.ts TypeScript Types: type TApiParams = Record<string, string>

const typeParamsSchema = z.object({ userId: z.coerce.string(), playerId: z.coerce.number(), }) satisfies
z.ZodType<TPlayerMapParams>
...
export type TPlayerMap = { mapId: number }

export type TPlayerMapRecordByMapId = Record<string, TPlayerMap>

Hook for mutate data using SWR

function path :methods/hooks/world/core/useMutatePlayerMap.ts function useMutatePlayerMap( params: TPlayerMapParams)
PostgreSQL Database "schema": "world" "method": "get_player_map" You have more information in mcp game-db
