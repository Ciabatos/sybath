...
app/api/world/rpc/get-player-position/[mapId]/[playerId]/route.ts TypeScript Types: type TApiParams = Record<string,
string>
...
export type TPlayerPosition = { x: number y: number imageMap: string inSquad: boolean }

export type TPlayerPositionRecordByXY = Record<string, TPlayerPosition>

Hook for mutate data using SWR

function path :methods/hooks/world/core/useMutatePlayerPosition.ts function useMutatePlayerPosition( params:
TPlayerPositionParams) PostgreSQL Database "schema": "world" "method": "get_player_position" You have more information
in mcp game-db
