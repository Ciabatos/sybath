...
app/api/world/rpc/get-known-map-tiles/[mapId]/[playerId]/route.ts TypeScript Types: type TApiParams = Record<string,
string>
...
export type TKnownMapTiles = { mapId: number x: number y: number terrainTypeId: number landscapeTypeId: number }

export type TKnownMapTilesRecordByXY = Record<string, TKnownMapTiles>

Hook for mutate data using SWR

function path :methods/hooks/world/core/useMutateKnownMapTiles.ts function useMutateKnownMapTiles( params:
TKnownMapTilesParams) PostgreSQL Database "schema": "world" "method": "get_known_map_tiles" You have more information in
mcp game-db
