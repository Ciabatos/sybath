...
"use client"
import { TPlayerVisibleMapDataRecordByMapTileXMapTileY , TPlayerVisibleMapDataParams  } from "@/db/postgresMainDatabase/schemas/world/playerVisibleMapData"
...
export function useFetchPlayerVisibleMapData( params: TPlayerVisibleMapDataParams) {
  ...
  const { data } = useSWR(`/api/world/rpc/player-visible-map-data/${params.playerId}`, { refreshInterval: 3000 })
