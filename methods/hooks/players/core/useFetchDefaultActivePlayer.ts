...
"use client"
import { TDefaultActivePlayerRecordById, TDefaultActivePlayer , TDefaultActivePlayerClientParams  } from "@/db/postgresMainDatabase/schemas/players/defaultActivePlayer"
...
export function useFetchDefaultActivePlayer( params: TDefaultActivePlayerClientParams) {
  ...
  const { data } = useSWR<TDefaultActivePlayer[]>(`/api/players/rpc/get-default-active-player`, { refreshInterval: 3000 })
