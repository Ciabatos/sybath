...
# path: `app/api/players/rpc/get-default-active-player/[userId]/route.ts`
# TypeScript Types:
...
# function getDefaultActivePlayerServer( params: TDefaultActivePlayerParams, options?: { forceFresh?: boolean },): Promise<TResult>
# path: `methods/server-fetchers/players/core/getDefaultActivePlayerServer.ts`
# TypeScript Types:
...
# function getDefaultActivePlayer(params: TDefaultActivePlayerParams)
# path: `db/postgresMainDatabase/schemas/players/defaultActivePlayer.ts`
# TypeScript Types:
...
# function path :`methods/hooks/players/core/useMutateDefaultActivePlayer.ts`
# function useMutateDefaultActivePlayer( params: TDefaultActivePlayerParams)

#### PostgreSQL Database
# "schema": "players"
# "method": "get_default_active_player"
