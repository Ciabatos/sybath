...
"use client"
import { TPlayerRecipeMaterialsRecordById, TPlayerRecipeMaterials , TPlayerRecipeMaterialsClientParams  } from "@/db/postgresMainDatabase/schemas/items/playerRecipeMaterials"
...
export function useFetchPlayerRecipeMaterials( params: TPlayerRecipeMaterialsClientParams) {
  ...
  const { data } = useSWR<TPlayerRecipeMaterials[]>(`/api/items/rpc/get-player-recipe-materials/${params.playerId}/${params.recipeId}`, { refreshInterval: 3000 })
