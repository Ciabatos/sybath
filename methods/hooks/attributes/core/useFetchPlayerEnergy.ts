...
"use client"
import { TPlayerEnergyRecordByLastRegeneratedAt, TPlayerEnergy , TPlayerEnergyClientParams  } from "@/db/postgresMainDatabase/schemas/attributes/playerEnergy"
...
export function useFetchPlayerEnergy( params: TPlayerEnergyClientParams) {
  ...
  const { data } = useSWR<TPlayerEnergy[]>(`/api/attributes/rpc/get-player-energy/${params.playerId}`, { refreshInterval: 3000 })
