...
"use client"
import { TTradesRecordById, TTrades, TTradesClientParams } from "@/db/postgresMainDatabase/schemas/trade/trades"
...
export function useFetchTrades(params: TTradesClientParams) {
