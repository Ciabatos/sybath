DROP FUNCTION players.other_player_knowledge_request(int4, text, int4);

CREATE OR REPLACE FUNCTION knowledge.other_player_knowledge_request(p_player_id integer, p_other_player_id text, p_knowledge_type_id integer)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
