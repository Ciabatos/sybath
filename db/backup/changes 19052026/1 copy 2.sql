DROP FUNCTION players.discover_other_player_abilities(int4, int4);

CREATE OR REPLACE FUNCTION knowledge.discover_other_player_abilities(p_player_id integer, p_other_player_id integer)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
