...
-- Started on 2025-11-21 00:39:55
...
--
-- TOC entry 308 (class 1255 OID 17357)
...
--
-- TOC entry 325 (class 1255 OID 17358)
...
--
-- TOC entry 313 (class 1255 OID 17359)
-- Name: get_ability_requirements(); Type: FUNCTION; Schema: attributes; Owner: postgres
--

CREATE FUNCTION attributes.get_ability_requirements() RETURNS SETOF attributes.ability_requirements
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM attributes.ability_requirements;
      END;
      $$;


ALTER FUNCTION attributes.get_ability_requirements() OWNER TO postgres;

--
-- TOC entry 320 (class 1255 OID 17360)
-- Name: get_ability_requirements_by_key(integer); Type: FUNCTION; Schema: attributes; Owner: postgres
--

CREATE FUNCTION attributes.get_ability_requirements_by_key(p_ability_id integer) RETURNS SETOF attributes.ability_requirements
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION attributes.get_ability_requirements_by_key(p_ability_id integer) OWNER TO postgres;
...
--
-- TOC entry 323 (class 1255 OID 17361)
...
--
-- TOC entry 332 (class 1255 OID 17362)
...
--
-- TOC entry 340 (class 1255 OID 17363)
...
--
-- TOC entry 344 (class 1255 OID 17364)
...
--
-- TOC entry 289 (class 1255 OID 17365)
...
--
-- TOC entry 291 (class 1255 OID 17366)
...
--
-- TOC entry 346 (class 1255 OID 17346)
-- Name: add_item_to_inventory(integer, integer, integer); Type: FUNCTION; Schema: items; Owner: postgres
--

CREATE FUNCTION items.add_item_to_inventory(p_player_id integer, p_item_id integer, p_quantity integer) RETURNS TABLE(status text, message text, slot_row integer, slot_col integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
    updated_row RECORD;
BEGIN
    SELECT T2.row, T2.col, T2.inventory_container_id
    INTO updated_row
    FROM players.inventory_containers T1
    JOIN players.inventory_slots T2
      ON T2.inventory_container_id = T1.id
    ...
    IF NOT FOUND THEN
        RETURN QUERY SELECT 'fail', 'No free slot in inventory', NULL, NULL;
        RETURN;
    END IF;
    ...
    RETURN QUERY SELECT 'ok', 'Item added successfully', updated_row.row, updated_row.col;
END;
$$;


ALTER FUNCTION items.add_item_to_inventory(p_player_id integer, p_item_id integer, p_quantity integer) OWNER TO postgres;

--
-- TOC entry 328 (class 1255 OID 17258)
...
--
-- TOC entry 329 (class 1255 OID 17259)
...
--
-- TOC entry 292 (class 1255 OID 17367)
...
--
-- TOC entry 293 (class 1255 OID 17368)
...
--
-- TOC entry 330 (class 1255 OID 17260)
...
--
-- TOC entry 339 (class 1255 OID 17206)
...
--
-- TOC entry 342 (class 1255 OID 16725)
...
--
-- TOC entry 327 (class 1255 OID 17030)
...
--
-- TOC entry 333 (class 1255 OID 17378)
-- Name: get_buildings(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_buildings() RETURNS SETOF map.buildings
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.buildings;
      END;
      $$;


ALTER FUNCTION map.get_buildings() OWNER TO postgres;

--
-- TOC entry 341 (class 1255 OID 17379)
-- Name: get_buildings_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_buildings_by_key(p_id integer) RETURNS SETOF map.buildings
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_buildings_by_key(p_id integer) OWNER TO postgres;
...
--
-- TOC entry 304 (class 1255 OID 17351)
-- Name: get_cities(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_cities() RETURNS SETOF map.cities
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.cities;
      END;
      $$;


ALTER FUNCTION map.get_cities() OWNER TO postgres;

--
-- TOC entry 295 (class 1255 OID 17375)
-- Name: get_cities_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_cities_by_key(p_id integer) RETURNS SETOF map.cities
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_cities_by_key(p_id integer) OWNER TO postgres;

--
-- TOC entry 305 (class 1255 OID 17352)
-- Name: get_cities_by_key(integer, integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_cities_by_key(p_map_tile_x integer, p_map_tile_y integer) RETURNS SETOF map.cities
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_cities_by_key(p_map_tile_x integer, p_map_tile_y integer) OWNER TO postgres;
...
--
-- TOC entry 302 (class 1255 OID 17380)
-- Name: get_city_tiles(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_city_tiles() RETURNS SETOF map.city_tiles
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.city_tiles;
      END;
      $$;


ALTER FUNCTION map.get_city_tiles() OWNER TO postgres;

--
-- TOC entry 303 (class 1255 OID 17382)
-- Name: get_city_tiles_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_city_tiles_by_key(p_city_id integer) RETURNS SETOF map.city_tiles
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_city_tiles_by_key(p_city_id integer) OWNER TO postgres;

--
-- TOC entry 301 (class 1255 OID 17381)
-- Name: get_city_tiles_by_key(integer, integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_city_tiles_by_key(p_x integer, p_y integer) RETURNS SETOF map.city_tiles
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_city_tiles_by_key(p_x integer, p_y integer) OWNER TO postgres;
...
--
-- TOC entry 297 (class 1255 OID 17376)
-- Name: get_districts(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_districts() RETURNS SETOF map.districts
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.districts;
      END;
      $$;


ALTER FUNCTION map.get_districts() OWNER TO postgres;

--
-- TOC entry 299 (class 1255 OID 17377)
-- Name: get_districts_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_districts_by_key(p_id integer) RETURNS SETOF map.districts
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_districts_by_key(p_id integer) OWNER TO postgres;
...
--
-- TOC entry 290 (class 1255 OID 17373)
-- Name: get_landscape_types(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_landscape_types() RETURNS SETOF map.landscape_types
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.landscape_types;
      END;
      $$;


ALTER FUNCTION map.get_landscape_types() OWNER TO postgres;

--
-- TOC entry 294 (class 1255 OID 17374)
-- Name: get_landscape_types_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_landscape_types_by_key(p_id integer) RETURNS SETOF map.landscape_types
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_landscape_types_by_key(p_id integer) OWNER TO postgres;
...
-- Name: get_map_tiles(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_map_tiles() RETURNS SETOF map.map_tiles
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.map_tiles;
      END;
      $$;


ALTER FUNCTION map.get_map_tiles() OWNER TO postgres;

--
-- TOC entry 300 (class 1255 OID 17372)
-- Name: get_map_tiles_by_key(integer, integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_map_tiles_by_key(p_x integer, p_y integer) RETURNS SETOF map.map_tiles
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_map_tiles_by_key(p_x integer, p_y integer) OWNER TO postgres;
...
--
-- TOC entry 296 (class 1255 OID 17369)
-- Name: get_terrain_types(); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_terrain_types() RETURNS SETOF map.terrain_types
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
          SELECT * FROM map.terrain_types;
      END;
      $$;


ALTER FUNCTION map.get_terrain_types() OWNER TO postgres;

--
-- TOC entry 298 (class 1255 OID 17370)
-- Name: get_terrain_types_by_key(integer); Type: FUNCTION; Schema: map; Owner: postgres
--

CREATE FUNCTION map.get_terrain_types_by_key(p_id integer) RETURNS SETOF map.terrain_types
    LANGUAGE plpgsql
    AS $$
      BEGIN
          RETURN QUERY
...
ALTER FUNCTION map.get_terrain_types_by_key(p_id integer) OWNER TO postgres;
...
--
-- TOC entry 334 (class 1255 OID 16577)
...
--
-- TOC entry 345 (class 1255 OID 17344)
...
--
-- TOC entry 338 (class 1255 OID 16974)
...
--
-- TOC entry 336 (class 1255 OID 16696)
...
--
-- TOC entry 322 (class 1255 OID 16971)
...
--
-- TOC entry 306 (class 1255 OID 17355)
...
--
-- TOC entry 307 (class 1255 OID 17356)
...
--
-- TOC entry 335 (class 1255 OID 17203)
...
--
-- TOC entry 331 (class 1255 OID 17331)
...
--
-- TOC entry 324 (class 1255 OID 17310)
...
--
-- TOC entry 4881 (class 2604 OID 16936)
...
--
-- TOC entry 4894 (class 2604 OID 17265)
...
--
-- TOC entry 4879 (class 2604 OID 16922)
...
--
-- TOC entry 4880 (class 2604 OID 16929)
...
--
-- TOC entry 4866 (class 2604 OID 16474)
...
--
-- TOC entry 4867 (class 2604 OID 16483)
...
--
-- TOC entry 4868 (class 2604 OID 16513)
...
--
-- TOC entry 4893 (class 2604 OID 17254)
...
--
-- TOC entry 4876 (class 2604 OID 16885)
...
--
-- TOC entry 4891 (class 2604 OID 17190)
...
--
-- TOC entry 4890 (class 2604 OID 17183)
...
--
-- TOC entry 4887 (class 2604 OID 17097)
...
--
-- TOC entry 4886 (class 2604 OID 17090)
...
--
-- TOC entry 4884 (class 2604 OID 17006)
...
--
-- TOC entry 4888 (class 2604 OID 17104)
...
--
-- TOC entry 4889 (class 2604 OID 17126)
...
--
-- TOC entry 4875 (class 2604 OID 16690)
...
--
-- TOC entry 4869 (class 2604 OID 16540)
...
--
-- TOC entry 4883 (class 2604 OID 16950)
...
--
-- TOC entry 4882 (class 2604 OID 16943)
...
--
-- TOC entry 4874 (class 2604 OID 16647)
...
--
-- TOC entry 4872 (class 2604 OID 16634)
...
--
-- TOC entry 4896 (class 2604 OID 17325)
...
--
-- TOC entry 4895 (class 2604 OID 17316)
...
--
-- TOC entry 5150 (class 0 OID 16933)
-- Dependencies: 250
...
--
-- TOC entry 5172 (class 0 OID 17229)
-- Dependencies: 274
...
--
-- TOC entry 5176 (class 0 OID 17262)
-- Dependencies: 278
...
--
-- TOC entry 5146 (class 0 OID 16919)
-- Dependencies: 246
...
--
-- TOC entry 5148 (class 0 OID 16926)
-- Dependencies: 248
...
--
-- TOC entry 5125 (class 0 OID 16471)
-- Dependencies: 225
...
--
-- TOC entry 5129 (class 0 OID 16510)
-- Dependencies: 229
...
INSERT INTO auth.users VALUES (29, NULL, 'example@example.com', NULL, NULL, '$2b$10$l6wWTVh7TV8V5hBzZeatFOZTCzr6Z9DxV1Ltv95QVDnQnZQkBKQey');


--
-- TOC entry 5123 (class 0 OID 16463)
-- Dependencies: 223
...
--
-- TOC entry 5171 (class 0 OID 17207)
-- Dependencies: 273
...
--
-- TOC entry 5174 (class 0 OID 17251)
-- Dependencies: 276
...
--
-- TOC entry 5142 (class 0 OID 16882)
-- Dependencies: 242
...
--
-- TOC entry 5144 (class 0 OID 16892)
-- Dependencies: 244
...
--
-- TOC entry 5170 (class 0 OID 17187)
-- Dependencies: 272
...
--
-- TOC entry 5168 (class 0 OID 17180)
-- Dependencies: 270
...
--
-- TOC entry 5177 (class 0 OID 17268)
-- Dependencies: 279
...
--
-- TOC entry 5162 (class 0 OID 17094)
-- Dependencies: 262
...
--
-- TOC entry 5160 (class 0 OID 17087)
-- Dependencies: 260
...
--
-- TOC entry 5156 (class 0 OID 17003)
-- Dependencies: 256
...
--
-- TOC entry 5178 (class 0 OID 17273)
-- Dependencies: 280
...
--
-- TOC entry 5158 (class 0 OID 17070)
-- Dependencies: 258
...
--
-- TOC entry 5179 (class 0 OID 17278)
-- Dependencies: 281
...
--
-- TOC entry 5164 (class 0 OID 17101)
-- Dependencies: 264
...
--
-- TOC entry 5166 (class 0 OID 17123)
-- Dependencies: 266
...
--
-- TOC entry 5140 (class 0 OID 16687)
-- Dependencies: 240
...
--
-- TOC entry 5157 (class 0 OID 17017)
-- Dependencies: 257
...
--
-- TOC entry 5131 (class 0 OID 16537)
-- Dependencies: 231
...
--
-- TOC entry 5133 (class 0 OID 16544)
-- Dependencies: 233
...
--
-- TOC entry 5154 (class 0 OID 16947)
-- Dependencies: 254
...
--
-- TOC entry 5152 (class 0 OID 16940)
-- Dependencies: 252
...
--
-- TOC entry 5138 (class 0 OID 16644)
-- Dependencies: 238
...
--
-- TOC entry 5136 (class 0 OID 16631)
-- Dependencies: 236
...
INSERT INTO players.players VALUES (4, 15, 'DrugiPlayer', 'default.png');


--
-- TOC entry 5182 (class 0 OID 17321)
-- Dependencies: 284
...
--
-- TOC entry 5181 (class 0 OID 17313)
-- Dependencies: 283
...
INSERT INTO tasks.tasks VALUES (1276, 1, 5, '2025-07-01 03:06:24.792785', '2025-07-01 03:11:24.79+02', NULL, NULL, 'map.movementAction', '{"x": 2, "y": 3, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1277, 1, 5, '2025-07-01 03:06:24.802364', '2025-07-01 03:11:24.8+02', NULL, NULL, 'map.movementAction', '{"x": 3, "y": 2, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1278, 1, 5, '2025-07-01 03:06:24.803419', '2025-07-01 03:11:24.8+02', NULL, NULL, 'map.movementAction', '{"x": 4, "y": 3, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1279, 1, 5, '2025-07-01 03:06:24.804612', '2025-07-01 03:11:24.8+02', NULL, NULL, 'map.movementAction', '{"x": 5, "y": 2, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1280, 1, 5, '2025-07-01 03:06:24.805394', '2025-07-01 03:11:24.81+02', NULL, NULL, 'map.movementAction', '{"x": 6, "y": 2, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1281, 1, 5, '2025-07-09 23:25:52.04431', '2025-07-09 23:30:52.04+02', NULL, NULL, 'map.movementAction', '{"x": 2, "y": 5, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1282, 1, 5, '2025-07-09 23:25:52.056279', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 3, "y": 6, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1283, 1, 5, '2025-07-09 23:25:52.056782', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 4, "y": 7, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1284, 1, 5, '2025-07-09 23:25:52.057232', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 5, "y": 8, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1285, 1, 5, '2025-07-09 23:25:52.057626', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 6, "y": 8, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1286, 1, 5, '2025-07-09 23:25:52.057999', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 7, "y": 9, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1287, 1, 5, '2025-07-09 23:25:52.058332', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 8, "y": 9, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1288, 1, 5, '2025-07-09 23:25:52.058677', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 9, "y": 9, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1289, 1, 5, '2025-07-09 23:25:52.059001', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 10, "y": 8, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1290, 1, 5, '2025-07-09 23:25:52.059317', '2025-07-09 23:30:52.06+02', NULL, NULL, 'map.movementAction', '{"x": 11, "y": 8, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (
NULL, NULL, 'map.movementAction', '{"x": 6, "y": 6, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1672, 1, 5, '2025-07-27 15:18:06.909163', '2025-07-27 15:23:06.91+02', NULL, NULL, 'map.movementAction', '{"x": 7, "y": 7, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1673, 1, 1, '2025-11-12 21:34:43.067014', '2025-11-12 21:39:43.07+01', NULL, NULL, 'map.movementAction', '{"x": 2, "y": 5, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1674, 1, 1, '2025-11-12 21:34:43.078174', '2025-11-12 21:39:43.08+01', NULL, NULL, 'map.movementAction', '{"x": 3, "y": 6, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1675, 1, 1, '2025-11-12 21:34:43.078517', '2025-11-12 21:39:43.08+01', NULL, NULL, 'map.movementAction', '{"x": 4, "y": 5, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1676, 1, 1, '2025-11-12 21:34:43.0788', '2025-11-12 21:39:43.08+01', NULL, NULL, 'map.movementAction', '{"x": 5, "y": 4, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1677, 1, 1, '2025-11-12 21:34:43.079621', '2025-11-12 21:39:43.08+01', NULL, NULL, 'map.movementAction', '{"x": 6, "y": 4, "playerId": 1}');
INSERT INTO tasks.tasks VALUES (1678, 1, 1, '2025-11-12 21:34:43.079932', '2025-11-12 21:39:43.08+01', NULL, NULL, 'map.movementAction', '{"x": 7, "y": 3, "playerId": 1}');
...
SELECT pg_catalog.setval('players.players_id_seq', 6, true);
...
SELECT pg_catalog.setval('tasks.tasks_id_seq', 1678, true);


--
-- TOC entry 4933 (class 2606 OID 16938)
...
--
-- TOC entry 4964 (class 2606 OID 17267)
...
--
-- TOC entry 4929 (class 2606 OID 16924)
...
--
-- TOC entry 4931 (class 2606 OID 16931)
...
--
-- TOC entry 4960 (class 2606 OID 17235)
...
--
-- TOC entry 4903 (class 2606 OID 16478)
...
--
-- TOC entry 4958 (class 2606 OID 17211)
...
--
-- TOC entry 4962 (class 2606 OID 17256)
...
--
-- TOC entry 4923 (class 2606 OID 16888)
...
--
-- TOC entry 4925 (class 2606 OID 16900)
...
--
-- TOC entry 4927 (class 2606 OID 16898)
...
--
-- TOC entry 4956 (class 2606 OID 17192)
...
--
-- TOC entry 4954 (class 2606 OID 17185)
...
--
-- TOC entry 4966 (class 2606 OID 17272)
...
--
-- TOC entry 4948 (class 2606 OID 17099)
...
--
-- TOC entry 4946 (class 2606 OID 17092)
...
--
-- TOC entry 4939 (class 2606 OID 17008)
...
--
-- TOC entry 4968 (class 2606 OID 17277)
...
--
-- TOC entry 4944 (class 2606 OID 17075)
...
--
-- TOC entry 4970 (class 2606 OID 17282)
...
--
-- TOC entry 4950 (class 2606 OID 17106)
...
--
-- TOC entry 4952 (class 2606 OID 17128)
...
--
-- TOC entry 4921 (class 2606 OID 16692)
...
--
-- TOC entry 4915 (class 2606 OID 17001)
...
--
-- TOC entry 4942 (class 2606 OID 17021)
...
--
-- TOC entry 4937 (class 2606 OID 16952)
...
--
-- TOC entry 4935 (class 2606 OID 16945)
...
--
-- TOC entry 4919 (class 2606 OID 16649)
...
--
-- TOC entry 4974 (class 2606 OID 17330)
...
--
-- TOC entry 4972 (class 2606 OID 17320)
...
--
-- TOC entry 4940 (class 1259 OID 17036)
...
--
-- TOC entry 4975 (class 2606 OID 17236)
...
-- Completed on 2025-11-21 00:39:56
