...
export async function getActivePlayerPosition(params: TGetActivePlayerPositionParams) {
  try {
    ...
    console.error("Error fetching getActivePlayerPosition:", error)
    throw new Error("Failed to fetch getActivePlayerPosition")
  }
}
