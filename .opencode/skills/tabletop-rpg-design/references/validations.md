...
Multiple stacking modifiers slow play and create rules-lawyer opportunities. Consider advantage/disadvantage or
position/effect instead.
...
Niche options that rarely apply can be trap choices for inexperienced players. Consider if this option earns its
rules-space.
...
Systems tracking many rounds, individual initiative, and HP can lead to 45+ minute combats. Consider streamlined
alternatives.
...
Consider including safety tool references (X-Card, Lines and Veils, Script Change) in core rules or Session Zero
guidance.
...
If progression is primarily numerical (+X per level), gameplay doesn't change. Level 10 feels like level 1 with bigger
numbers.
