...
const typeParamsSchema = z.object({
  id: z.coerce.number(),
}) satisfies z.ZodType<TMapTerrainTypesParams>

export async function GET(request: NextRequest, params: TMapTerrainTypesParams ): Promise<NextResponse> {
  ...
  try {
    const result = await getMapTerrainTypesByKey(parsedParams)
