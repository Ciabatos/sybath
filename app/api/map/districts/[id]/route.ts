...
const typeParamsSchema = z.object({
  id: z.coerce.number(),
}) satisfies z.ZodType<TMapDistrictsParams>

export async function GET(request: NextRequest, params: TMapDistrictsParams ): Promise<NextResponse> {
  ...
  try {
    const result = await getMapDistrictsByKey(parsedParams)
