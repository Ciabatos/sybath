...
const typeParamsSchema = z.object({
  id: z.coerce.number(),
}) satisfies z.ZodType<TMapLandscapeTypesParams>

export async function GET(request: NextRequest, params: TMapLandscapeTypesParams ): Promise<NextResponse> {
  ...
  try {
    const result = await getMapLandscapeTypesByKey(parsedParams)
