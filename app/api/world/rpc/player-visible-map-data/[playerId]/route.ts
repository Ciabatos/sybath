...
import { getPlayerVisibleMapData, TPlayerVisibleMapDataParams } from "@/db/postgresMainDatabase/schemas/world/playerVisibleMapData"
...
}) satisfies z.ZodType<TPlayerVisibleMapDataParams>
...
export async function GET(request: NextRequest, { params }: { params: TApiParams }): Promise<NextResponse> {
  ...
  try {
    const result = await getPlayerVisibleMapData(parsedParams)
