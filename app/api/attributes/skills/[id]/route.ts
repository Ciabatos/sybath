...
export async function GET(request: NextRequest, params: TAttributesSkillsParams ): Promise<NextResponse> {
  ...
  try {
    const result = await getAttributesSkillsByKey(parsedParams)
